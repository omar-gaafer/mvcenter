...
var siteData = {
  ...
  ads: [
    {
      id: 1,
      tag: 'عرض خاص والتغذية المثالية',
      title: 'أعلاف شركة مصر للأعلاف — التغذية المعتمدة لأعلى كفاءة تحويل',
      text: 'تركيبات علفية متوازنة 100% مصممة خصيصاً لدواجن التسمين والمواشي لضمان معدلات نمو فائقة.',
      icon: '🌾',
      featured: true,
      fullDetails: 'يفخر المركز البيطري الحديث بالسنطة بتوفير أعلاف شركة مصر للأعلاف، الرائدة في صناعة الأعلاف المركزة والمكتملة العناصر الغذائية. تمتاز تركيبات مصر للأعلاف بخلوها من المسببات الفطرية ونسب بروتين محسوبة بدقة لتلبية احتياجات كافة مراحل التربية (بادئ، نامي، وناهي للدواجن، وأعلاف تسمين وإدرار الحليب للمواشي).',
      promoPhrase: '✦ متوفر الآن حصرياً لدى المركز البيطري الحديث بالسنطة بأسعار التوريد المباشر!',
      highlights: [
        'تركيبات علفية عالية الجودة بمعايير قياسية',
        'أعلى معدل تحويل غذائي ونمو متكافئ للقطيع',
        'أسعار خاصة للمزارع والمربين وتوريد مباشر'
      ]
    },
    {
      id: 2,
      tag: 'برامج التحصين الوقائي',
      title: 'جدول التحصينات الموسمية لحماية القطيع من الوبائيات',
      text: 'خطط وقائية متكاملة تناسب الفصول المختلفة للحد من مخاطر الإصابات الفيروسية والبكتيرية.',
      icon: '🛡',
      featured: false,
      fullDetails: 'الوقاية المبكرة هي الخط الأول لحماية استثماراتك في التربية. يوفر المركز البيطري الحديث بالسنطة لقاحات حية ومثبطة محفوظة وفق أحدث اشتراطات التبريد والتخزين، مع جدول إرشادي مخصص لكل عمر ونوع (دواجن تسمين، بياض، أبقار، وجاموس).',
      promoPhrase: '✦ احصل على استشارة وتخطيط برنامج التحصين الخاص بمزرعتك مجاناً بالمركز!',
      highlights: [
        'تخزين مبرد وتبريد دقيق لحفظ فاعلية اللقاحات',
        'جدول رعاية وتحصين متدرج حسب عمر القطيع',
        'إرشادات الأمان الحيوي وتطهير العنابر'
      ]
    },
    {
      id: 3,
      tag: 'استشارات الدعم العلاجي',
      title: 'بروتوكولات التشخيص والجرعات البيطرية الدقيقة',
      text: 'استخدام المضادات الحيوية والمضادات الفطرية وفق الإرشاد البيطري الصحيح لتفادي مقاومة الأدوية.',
      icon: '⚕',
      featured: false,
      fullDetails: 'الاستخدام العشوائي للأدوية البيطرية قد يضر بالقطيع ويقلل من الاستجابة العلاجية. نحن بالمركز البيطري الحديث نضمن لك الحصول على المستحضر المناسب بالجرعة المضبوطة وفق الوزن والنوع، مع توفير مطهرات ومعقمات عنابر معتمدة لضمان بيئة صحية خالية من الأمراض.',
      promoPhrase: '✦ تواصل مع دكتور حسام جعفر لتحديد العلاج الأنسب والجرعة الدقيقة لكل حالة.',
      highlights: [
        'مستحضرات بيطرية محلية ومستوردة مسجلة بوزارة الزراعة',
        'تحديد الجرعات بدقة لمنع الآثار الجانبية',
        'دعم فني ومتابعة مستمرة لتطور الحالة'
      ]
    },
    {
      id: 4,
      tag: 'دعم الإنتاج والمناعة',
      title: 'مجموعات الفيتامينات ومغسلات الكلى لرفع الإنتاجية',
      text: 'حلول غذائية متقدمة لمواجهة الإجهاد الحراري وطرد السموم الفطرية من الجسم.',
      icon: '✚',
      featured: false,
      fullDetails: 'تجاوز فترات الإجهاد الحراري وتغير الفصول يتطلب دعماً مناعياً مركزاً. نوفر لك أفضل أنواع فيتامينات (أ د3 هـ)، والأحماض العضوية، ومنشطات الكبد ومغسلات الكلى البيطرية التي تضمن سرعة الامتصاص وحماية الجهاز الهضمي والحيوي للقطيع.',
      promoPhrase: '✦ باقات المكملات الغذائية ومنشطات الكبد متوفرة بخصومات للمزارع!',
      highlights: [
        'رفع مناعة القطيع وتجاوز فترات الإجهاد',
        'طرد السموم الفطرية وتحسين الكفاءة الهضمية',
        'تركيبات سائلة وسريعة الذوبان في مياه الشرب'
      ]
    }
  ],
  partners: [
